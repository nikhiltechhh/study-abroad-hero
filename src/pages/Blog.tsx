...
import blogHeroBg from '@/assets/bg1.jpg';
...
const Blog = () => {
  ...
  const categories = ['All', 'Study Destinations', 'Visa Guide', 'Policy Updates', 'Scholarships', 'Student Life', 'Test Preparation'];
  ...
  return (
    <div className="min-h-screen bg-background -mt-20">
      ...
      <div className="relative bg-gradient-primary text-primary-foreground py-24 px-4 mt-20 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          <p className="text-xl md:text-2xl opacity-95 max-w-3xl leading-relaxed animate-in fade-in slide-in-from-bottom-6 duration-700 delay-150">
            Stay informed with the latest updates, guides, and tips for your international education journey
          </p>
        </div>
      </div>
        ...
        <div className="mb-12">
          <div className="relative mb-6">
            ...
            <input
              ...
              className="w-full pl-12 pr-4 py-3 bg-card border border-border rounded-lg focus:ring-2 focus:ring-ring focus:border-transparent outline-none text-foreground"
            />
          </div>
        ...
        {selectedCategory === 'All' && !searchTerm && (
          <div className="mb-16">
            ...
            <div 
              ...
              className="bg-card rounded-2xl shadow-card overflow-hidden hover:shadow-hover transition-all cursor-pointer"
            >
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {filteredPosts.map(post => (
              <article 
                ...
                className="bg-card rounded-xl shadow-card overflow-hidden hover:shadow-hover transition-all duration-300 hover:-translate-y-1 flex flex-col cursor-pointer"
              >
                ...
                <div className="p-6 flex-1 flex flex-col">
                  ...
                  <div className="flex flex-wrap gap-2 mb-4">
                    {post.tags.map(tag => (
                      <span key={tag} className="flex items-center gap-1 text-xs text-muted-foreground bg-muted px-2 py-1 rounded">
                  ...
                  <button className="mt-4 w-full flex items-center justify-center gap-2 text-primary font-semibold hover:bg-accent py-2 rounded-lg transition-all group">
                    Read More
          ...
          <div className="max-w-3xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 max-w-md mx-auto">
              <input
                ...
                className="flex-1 px-4 py-3 rounded-lg text-foreground bg-background outline-none focus:ring-2 focus:ring-ring"
              />
              <button className="bg-background text-primary px-8 py-3 rounded-lg font-semibold hover:opacity-90 transition-opacity">
                Subscribe
              </button>
            </div>
          </div>
